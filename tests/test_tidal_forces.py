...
class TestSolidTideForce:
    ...
    def test_magnitude_at_leo(self):
        ...
        from humeris.domain.tidal_forces import SolidTideForce
    ...
    def test_love_number_k2(self):
        ...
        from humeris.domain.tidal_forces import _K20
        assert abs(_K20 - 0.30190) < 0.01

    def test_love_numbers_exist(self):
        """All three k2m values should be defined."""
        from humeris.domain.tidal_forces import _K20, _K21, _K22
        assert _K20 > 0
        assert _K21 > 0
        assert _K22 > 0
...
class TestOceanTideForce:
    ...
    def test_magnitude_at_leo(self):
        ...
        from humeris.domain.tidal_forces import OceanTideForce
    ...
    def test_smaller_than_solid(self):
        ...
        from humeris.domain.tidal_forces import SolidTideForce, OceanTideForce
